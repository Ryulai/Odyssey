...
function ShowcaseLayout() {
  return (
    <ShowcaseProvider>
      <div className="min-h-screen w-full text-parchment relative overflow-x-hidden" style={{
        background: "radial-gradient(1200px 800px at 20% -10%, #1a0f1e 0%, transparent 50%), radial-gradient(1000px 700px at 100% 10%, #0e1420 0%, transparent 55%), #05040a",
      }}>
        {/* subtle grain */}
        ...
        <div className="flex relative z-10">
          ...
          <main className="flex-1 min-w-0">
            <header className="sticky top-0 z-30 flex items-center justify-between px-6 md:px-10 py-4 bg-gradient-to-b from-[#05040a]/95 to-transparent backdrop-blur-md">
