...
const HunterDashboardRoute = HunterDashboardRouteImport.update({
  id: '/hunter-dashboard',
...
const CodexCategoryRoute = CodexCategoryRouteImport.update({
  id: '/codex/$category',
  path: '/codex/$category',
  getParentRoute: () => rootRouteImport,
} as any)
const CodexCategoryIndexRoute = CodexCategoryIndexRouteImport.update({
  id: '/',
  path: '/',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/hunter-dashboard': {
      id: '/hunter-dashboard'
      path: '/hunter-dashboard'
      fullPath: '/hunter-dashboard'
      preLoaderRoute: typeof HunterDashboardRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/fleet': {
      id: '/fleet'
    ...
    '/codex/$category/': {
      ...
      path: '/'
      fullPath: '/codex/$category/'
      preLoaderRoute: typeof CodexCategoryIndexRouteImport
